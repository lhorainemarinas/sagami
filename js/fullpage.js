    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            //the comment below is the original code, just replaced it with the line below the comment for the navigations to append only on the parent div of fullpage
            // $body.append('<div id="' + SECTION_NAV + '"><ul></ul></div>');
            container.closest('.fp-slides').append('<div id="' + SECTION_NAV + '"><ul></ul></div>');
